<div class="ribbon-wrapper-green">
    <p class="text-title text-lg-center ribbon-cavaleiros"><br/>andamento</p>
</div>
<br/>
<div class="container">
    <div class="row">
        @foreach($projects->where('status',3) as $project)
            <div class="col-sm-12">
                <div class="card card-block card-8">
                    ...
                    <br/>
                    <br/>
                        <p class="text-lg-center"><a class="btn btn-blue-cavaleiros btn-sm" href="{{route('homologation.index',['project'=>$project->id])}}">Resultado Preliminar <br/> de Inscritos</a></p>
                    @else
                        <p>INSERIR IMAGEM !!!!</p>
                    @endif
                </div>
